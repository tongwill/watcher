...
public class DataEngine {
    ...
    public String getJsonFromData(String path,Map<String, Object> context,boolean isComponent){
        ...
        for (String key : backConfigManager.getBackData().getDatas().keySet()){
            ServiceData serviceData=backConfigManager.getBackData().getDatas().get(key);
